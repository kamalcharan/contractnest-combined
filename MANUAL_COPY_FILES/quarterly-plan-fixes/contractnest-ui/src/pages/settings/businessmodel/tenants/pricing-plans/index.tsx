            ...
            >
              ...
              <div className="px-5 pb-5">
                {/* Three states, all driven by server truth:
                    ...
                    · subscribed to another one -> disabled; mid-term plan
                      changes are admin-intervention only, not self-service
                      (the backend refuses this with ALREADY_SUBSCRIBED
                      regardless of which plan is requested — disabling here
                      is honest, an enabled button would just error)
                    · not subscribed            -> Subscribe (this is also
                      how renewal works, once the prior plan has expired)  */}
                {isCurrent ? (
                  <div
