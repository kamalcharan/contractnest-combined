  ...
  try {
    ...
    const server = httpServer.listen(PORT, () => {
      ...
      if (groupsRoutesLoaded) {
        ...
        console.log('- POST   /api/search                                # Search group directory (legacy)');
        console.log('- POST   /api/ai-search                             # AI-powered search via n8n');
        ...
        console.log('  ✅ AI-powered intent-based search via n8n');
        console.log('  ✅ Multi-scope search (group/tenant/product)');
        console.log('  ✅ RBAC-enabled channel-aware search');
