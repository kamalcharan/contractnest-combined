  ...
  return (
    <div>
      <VaNiBubble colors={colors}>
        ...
        <p>Select which variants to include. You can also <strong style={{ color: colors.utility.primaryText }}>add your own</strong> if something is missing.</p>
      </VaNiBubble>
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <span style={{
          ...
          background: brandPrimary + '10', color: brandPrimary,
          border: `1px solid ${brandPrimary}25`,
        }}>
          {selCount}/{variants.length} selected
        </span>
        <button onClick={onToggleAll} style={{ fontSize: '12px', color: colors.utility.secondaryText, background: 'transparent', border: 'none', cursor: 'pointer', fontFamily: 'inherit' }}>
          Toggle All
        </button>
        <button
          onClick={() => { /* Modal coming in next phase */ }}
          style={{
            marginLeft: 'auto', background: brandPrimary + '08', color: brandPrimary,
        ...
        {variants.map((v) => {
          ...
          return (
            <div
              ...
              style={{
                background: sel ? brandPrimary + '06' : colors.utility.secondaryBackground,
                border: `1px solid ${sel ? brandPrimary : borderColor}`,
            ...
            >
              <div style={{
                ...
                border: sel ? 'none' : `2px solid ${borderColor}`,
                background: sel ? brandPrimary : 'transparent',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontSize: '11px', color: sel ? '#fff' : 'transparent', transition: '.15s',
              }}>✓</div>
              <div style={{ flex: 1 }}>
