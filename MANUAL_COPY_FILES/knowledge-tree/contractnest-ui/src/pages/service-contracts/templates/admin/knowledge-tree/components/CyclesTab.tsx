  ...
  return (
    <div>
      ...
      {cycles.length === 0 ? (
        ...
        {/* Column headers */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 110px 150px 1fr 28px', gap: '14px', padding: '8px 18px', marginBottom: '6px', fontSize: '10px', fontWeight: 700, textTransform: 'uppercase' as const, letterSpacing: '.5px', color: colors.utility.secondaryText }}>
          <span>Checkpoint</span><span>Frequency</span><span>Varies By</span><span>Alert if Overdue</span><span></span>
        </div>
        {cycles.map((cy) => {
