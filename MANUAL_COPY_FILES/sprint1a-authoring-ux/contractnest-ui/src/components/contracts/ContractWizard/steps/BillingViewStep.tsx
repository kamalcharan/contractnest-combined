...
const BillingViewStep: React.FC<BillingViewStepProps> = ({
  ...
  }, [billableBlocks, emiMonths, discountType, discountValue]);
                ...
                <div className="ml-auto flex rounded-lg border overflow-hidden" style={{ borderColor: `${colors.utility.primaryText}15` }}>
                  {(['percent', 'amount'] as const).map((t) => (
                    <button
                      ...
                      style={{
                        backgroundColor: discountType === t ? colors.brand.primary : 'transparent',
                        color: discountType === t ? '#FFFFFF' : colors.utility.secondaryText,
                      }}
                    >
                ...
                <div className="flex items-center gap-2 mb-3">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      onDiscountChange(discountType, discountType === 'percent' ? Math.min(100, v) : v);
                    }}
                    ...
                    style={{ borderColor: `${colors.utility.primaryText}20`, color: colors.utility.primaryText, opacity: discountType ? 1 : 0.5 }}
                  />
                    ...
                    <details className="mt-2">
                      ...
                      <div className="mt-1.5 space-y-0.5">
                        {billableBlocks.map((b) => {
                          const ep = (b.config?.customPrice ?? b.price) * (b.unlimited ? 1 : b.quantity);
