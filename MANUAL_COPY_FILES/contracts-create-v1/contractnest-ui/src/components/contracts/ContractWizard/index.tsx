...
const ContractWizard: React.FC<ContractWizardProps> = ({
  ...
  const handleClose = useCallback(() => {
    ...
    if (isExperience && (wizardState.contractName.trim() || currentStep > 1)) {
    ...
    resetWizard();
    onClose();
  }, [resetWizard, onClose, isPastSaveThreshold, draftId, isTemplateMode, wizardState.contractName, wizardState.selectedBlocks.length, isExperience, currentStep]);
  ...
  }, [wizardState, contractType, draftId, createContract, updateContract, setSilentMode, isExperience]);
