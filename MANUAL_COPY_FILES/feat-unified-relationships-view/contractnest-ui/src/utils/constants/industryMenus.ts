...
export const defaultMenuItems: MenuItem[] = [
{
  ...
  // Operations menu - moved after Dashboard for better UX
  {
    ...
    submenuItems: [
      ...
      // MOVED: Contacts list merged into unified Relationships view under Contracts
  ...
  */
  // Contracts menu — unified Relationships + Contracts view
  {
    id: 'contracts',
    label: 'Contracts',
    icon: 'FileText',
    ...
    hasSubmenu: true,
    submenuItems: [
      { id: 'contracts-all', label: 'Relationships', icon: 'Users', path: '/contracts' },
