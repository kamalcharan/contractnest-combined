...
'src\components\contracts\ContractWizard\experience\CoveragePage.tsx',
...
Write-Host 'Copied 8 UI files. Restart UI and Ctrl+F5. Save Coverage, then Continue to services.' -ForegroundColor Green
