...
// Catalog Pages (legacy /catalog imports removed — see /catalog-studio)
  ...
  <Route path="done" element={
    <ProtectedRoute requireTenant={true}>
      <VaniDoneStep />
          ...
          {/* Legacy /catalog routes removed — superseded by /catalog-studio.
              Old service-catalog stack (pages, components, hooks, API routes,
              edge function, t_catalog_* tables) retired; all tenant data lives
              in m_cat_blocks. */}
