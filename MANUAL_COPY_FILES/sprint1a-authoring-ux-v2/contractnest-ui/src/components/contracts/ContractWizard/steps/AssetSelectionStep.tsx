...
const AssetSelectionStep: React.FC<AssetSelectionStepProps> = ({
  ...
  const attachedRegistryCount = useMemo(
    () => realDetails.filter((d) => coveredResourceIds.has(d.category_id || '')).length,
        ...
        <div className="px-6 pt-6 pb-6 max-w-3xl mx-auto">
          ...
          {uiStage === 'attach' && (
            <>
              ...
              {/* ── Registry picker (focused, collapses when done) ────── */}
                  ...
                  <div className="rounded-xl border p-4" style={{ borderColor: `${colors.utility.primaryText}12`, backgroundColor: colors.utility.secondaryBackground }}>
                    ...
                    {assetsLoading ? (
                      ...
                      <div className="text-center py-8">
                        <Package size={22} style={{ color: colors.utility.secondaryText, opacity: 0.4, margin: '0 auto 8px' }} />
                        <p className="text-sm" style={{ color: colors.utility.secondaryText }}>
                          {searchQuery ? `No matches for "${searchQuery}"` : 'No registered units for the types you picked'}
                        </p>
                      </div>
                    )}
        ...
        <div className="p-4">
          ...
          {uiStage === 'attach' && (
            <>
              ...
              <div className="rounded-lg border px-2.5 py-2" style={{ borderColor: `${colors.utility.primaryText}12` }}>
