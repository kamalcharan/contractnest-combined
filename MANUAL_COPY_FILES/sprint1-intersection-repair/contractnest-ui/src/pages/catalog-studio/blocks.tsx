              ...
              {filteredBlocks.map((block) => {
                ...
                return (
                  ...
                  >
                    ...
                    {(block as any).meta?.is_seed === 'true' && (block as any).meta?.seeded_from_name && (
                      <div
                        className="text-[10px] mb-1 inline-flex items-center gap-1 px-1.5 py-0.5 rounded"
                        style={{ backgroundColor: '#fff7ed', color: '#c2410c' }}
                        title={`Seeded from knowledge tree: ${(block as any).meta.seeded_from_name}`}
                      >
                        Seeded from {(block as any).meta.seeded_from_name}
                      </div>
                    )}
                    <p
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {(block as any).meta?.is_seed === 'true' && (block as any).meta?.seeded_from_name && (
                          <span
                            ...
                            title={`Seeded from knowledge tree: ${(block as any).meta.seeded_from_name}`}
                          >
                            Seeded · {(block as any).meta.seeded_from_name}
                          </span>
                        )}
                      </div>
                      <p
