  ...
  },
{
  ...
  */
  ...
  {
    id: 'seed-data',
    settings_type: 'Seed Data',
    parent_type: GROUP_BUSINESS_PROFILE,
    description_short: 'Manage seeded data',
    description_long: 'Review what onboarding seeded from your knowledge tree and re-seed catalog or registry data',
    route_path: '/settings/seed-data',
    card_icon_name: 'Database',
    adminOnly: false
  },
  {
