...
const VaNiChatPage: React.FC = () => {
  ...
  const renderResultCard = (result: SearchResult, index: number) => {
    ...
    const phone = result.business_phone || result.mobile_number;
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                {result.city && (
                  <span className="text-xs flex items-center" style={{ color: colors.utility.secondaryText }}>
