...
const CHAT_ENDPOINTS = {
  ...
  SESSION_BY_ID: (id: string) => `/api/chat/session/${id}`,
...
class ChatService {
  ...
  async init(): Promise<ChatInitResponse> {
    try {
      ...
      const response = await api.post(CHAT_ENDPOINTS.INIT, {});
  ...
  async getSession(channel: string = 'web'): Promise<ChatSessionResponse> {
    try {
      ...
      const response = await api.post(CHAT_ENDPOINTS.SESSION, { channel });
      return response.data;
    } catch (error: any) {
  ...
  async getSessionById(sessionId: string): Promise<ChatSessionResponse> {
    try {
      ...
      const response = await api.get(CHAT_ENDPOINTS.SESSION_BY_ID(sessionId));
      return response.data;
    } catch (error: any) {
  ...
  async activateGroup(request: {
    ...
    try {
      ...
      const response = await api.post(CHAT_ENDPOINTS.ACTIVATE, request);
      return response.data;
    } catch (error: any) {
  ...
  async setIntent(request: {
    ...
    try {
      ...
      const response = await api.post(CHAT_ENDPOINTS.INTENT, request);
      return response.data;
    } catch (error: any) {
  ...
  async search(request: {
    ...
    try {
      ...
      const response = await api.post(CHAT_ENDPOINTS.SEARCH, request);
      return response.data;
    } catch (error: any) {
  ...
  async endSession(sessionId: string): Promise<ChatEndResponse> {
    try {
      ...
      const response = await api.post(CHAT_ENDPOINTS.END, { session_id: sessionId });
      return response.data;
    } catch (error: any) {
