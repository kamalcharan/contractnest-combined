...
$files = @(
 ...
 'src\components\contracts\ContractWizard\experience\coverageModel.ts',
 'src\components\contracts\ContractWizard\experience\coverage.css'
)
...
Write-Host 'Copied 5 UI files. Restart UI and Ctrl+F5. Save Agreement, then Continue to coverage.' -ForegroundColor Green
