...
import {missingServiceSchedule} from './serviceScheduleRules';
import {
  getCadenceCycle,
  fittingCadences,
  cadenceTermMath,
...
const CommitmentEditor: React.FC<ChecklistRowProps & { instance: ConfigurableBlock }> = (props) => {
  ...
  const apply=()=>{
    ...
    if(missingServiceSchedule(instance)){setError(`${instance.quantity} service visits need a delivery interval. Set “Every ___ days”.`);return;}
