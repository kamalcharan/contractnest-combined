...
class KnowledgeTreeGeneratorService {
  ...
  //   facility full  — 16 000  (zones + consumables + checkpoints + cycles; no huge spare_part_variant_map)
  ...
  private getMaxTokens(existingKT: boolean, resourceType: string): number {
    ...
    return 16_000; // same budget for both types — facility has smaller maps, equipment has larger ones
  }
