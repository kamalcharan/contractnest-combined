  ...
  async (req: Request, res: Response) => {
    ...
    try {
      ...
      const body: CreateTemplateRequest = {
        ...
        // Previously omitted here, so every create request lost its KT
        // origin before reaching the edge function -- the edge function's
        // own fix (source defaulting) never mattered because this route
        // never forwarded the field in the first place.
