...
BEGIN
  ...
  -- t_catalog_resource_pricing (child - uses is_active, not is_live)
  ...
  -- t_catalog_service_resources (child - uses is_active, not is_live)
  ...
  -- t_tenant_files - skipped: no is_live/is_active column, cannot distinguish test vs live
