...
export const uploadQrImage = async (req: Request, res: Response) => {
  try {
    ...
    // Best-effort: if this is a genuine UPI merchant QR, silently surface
    // org_id/mcc so the tenant's check-in payment link classifies the
    // transaction correctly, without ever asking what these mean.
