  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden" style={{ backgroundColor: colors.utility.primaryBackground }}>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Contracts Tab - Placeholder for Part 2 */}
        {activeTab === 'contracts' && !cockpitLoading && (
          <div className="p-6 text-center py-20">
            ...
            <p className="text-sm" style={{ color: colors.utility.secondaryText }}>
              {cockpitData?.contracts?.total || 0} contracts linked to this contact
            </p>
            <p className="text-xs mt-2" style={{ color: colors.utility.secondaryText + '80' }}>
              Full contract list coming in Part 2
            </p>
          </div>
        )}

        {/* Assets Tab - Placeholder for Part 2 */}
        {activeTab === 'assets' && (
          <div className="p-6 text-center py-20">
            ...
            <p className="text-sm" style={{ color: colors.utility.secondaryText }}>
              Asset registry for this contact
            </p>
            <p className="text-xs mt-2" style={{ color: colors.utility.secondaryText + '80' }}>
              Full asset management coming in Part 2
            </p>
          </div>
        )}
