...
// Features: select existing assets, add new equipment/entity inline, let buyer add details

import React, { useMemo, useState, useCallback } from 'react';
import { Search, X, Wrench, Package, Layers, Plus, UserPlus, ChevronDown } from 'lucide-react';
