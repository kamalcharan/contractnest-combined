...
$files = @(
 'src\components\contracts\ContractWizard\experience\approved-agreement.css',
...
Write-Host 'Copied 2 UI files. Restart UI and Ctrl+F5. Test /contracts/experience/create?relationship=partner' -ForegroundColor Green
