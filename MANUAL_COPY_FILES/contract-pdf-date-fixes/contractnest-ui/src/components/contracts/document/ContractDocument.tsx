...
export function buildDocFromSavedContract(input: SavedContractDocInput): ContractDocumentData {
  ...
  // The contract's actual agreed start date — was previously read from
  // created_at (when the row was inserted), which is wrong whenever a
  // contract is created ahead of or behind its real start (e.g. signed
  // today, effective 1 Apr).
