...
'src\components\contracts\ContractWizard\experience\serviceCatalogModel.ts',
'src\components\contracts\ContractWizard\experience\useServiceCatalog.ts'
)
...
Write-Host 'Copied 8 UI files. Restart UI and Ctrl+F5. Test resource-scoped catalogue, mandatory T&C and FlyBy.' -ForegroundColor Green
