...
/** One tax component of an invoice's locked Sprint 4 snapshot (e.g. CGST 9%) */
...
export interface Invoice {
  ...
  amount: number;
  tax_amount: number;
  /** Sprint 4 tax snapshot, locked at issue (migration 062; returned by RPC since 067) */
  tax_breakdown?: InvoiceTaxComponent[] | null;
  total_amount: number;
  currency: string;
  amount_paid: number;
  balance: number;
