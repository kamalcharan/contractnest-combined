      ...
      <div>
        ...
        {profileIndustryId ? (
          ...
          >
            ...
            <button
              onClick={() => navigate('/settings/business-profile/edit')}
          ...
          >
            <p className="text-sm mb-2" style={{ color: colors.utility.secondaryText }}>
              No industry set yet. Set your business industry in your profile.
            </p>
            <button
              onClick={() => navigate('/settings/business-profile/edit')}
                  ...
                  >
                    ...
                    <div className="flex items-start space-x-3 pr-8">
                      ...
                      <div className="min-w-0">
                        {parentName && (
                          <div className="text-xs mb-0.5" style={{ color: colors.utility.secondaryText }}>
                            {parentName}
                          </div>
                        )}
