  ...
  return (
    ...
    >
      ...
      >
        ...
        {block.usage.templates === 0 && block.usage.contracts === 0 && (() => {
          const pricingRecords = block.meta?.pricingRecords as Array<{ currency: string; is_active: boolean }> | undefined;
          if (pricingRecords && pricingRecords.length > 1) {
            const currencies = pricingRecords
