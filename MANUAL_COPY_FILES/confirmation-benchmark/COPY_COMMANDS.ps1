...
$files = @('src\components\contracts\ContractWizard\experience\CompletionPage.tsx','src\components\contracts\ContractWizard\experience\completion.css')
...
Write-Host 'Copied 2 UI files. Restart UI and Ctrl+F5.' -ForegroundColor Green
