...
export interface ConfigurableBlock {
  ...
  config?: {
    ...
    notes?: string;
    // FlyBy-specific config
    sku?: string; // Spare parts
...
const BlockCardConfigurable: React.FC<BlockCardConfigurableProps> = ({
  ...
  // Check if this block's category supports pricing
      ...
      {expanded && (
        ...
        >
          <div className="pt-3 space-y-4">
            {/* Quantity Section - Only for pricing categories */}
            {hasPricing && (
              <div>
                <label
            ...
            {/* Billing Cycle Section - Only for pricing categories */}
            {hasPricing && (
              <div>
                <label
                  className="text-[10px] font-medium uppercase tracking-wide mb-1.5 block"
            ...
            >
              ...
              {/* Pricing Section - Only for pricing categories */}
              {hasPricing && (
            ...
            {/* Price Summary - Only for pricing categories */}
            {hasPricing && (
              <div
