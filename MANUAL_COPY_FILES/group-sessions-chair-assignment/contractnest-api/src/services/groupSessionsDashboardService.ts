...
class GroupSessionsDashboardService {
   ...
   * upserts/soft-deletes the linked appointment (gs_schedule_assign). */
  assignChair(tenantId: string, occurrenceId: string, assignedTo: string | null, assignedToName: string | null) {
  ...
  /** Set the default chair for every future, non-cancelled occurrence of a block. */
  assignDefaultChair(tenantId: string, blockId: string, isLive: boolean, assignedTo: string, assignedToName: string | null) {
