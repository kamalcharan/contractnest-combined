...
// UPDATED: Now uses ContactHeaderCard with compact variant for header
    ...
    <div className="flex flex-col h-screen overflow-hidden" style={{ backgroundColor: colors.utility.primaryBackground }}>
      ...
      >
        <button
          ...
          className="p-2 rounded-xl border transition-colors hover:opacity-80 flex items-center gap-2"
          style={{ backgroundColor: colors.utility.primaryBackground, borderColor: colors.utility.primaryText + '15', color: colors.utility.secondaryText }}
        >
      ...
      {/* ═══════════════════════════════════════════════════════════════════ */}
      {/* CONTACT HEADER CARD - Compact variant with LTV/Outstanding/Health */}
      {/* ═══════════════════════════════════════════════════════════════════ */}
      <div className="flex-shrink-0 px-6 py-4" style={{ backgroundColor: colors.utility.secondaryBackground }}>
        <ContactHeaderCard
          contact={contact}
          variant="compact"
          cockpitData={{
            ...
            health_score: cockpitData?.health_score || 0
          }}
