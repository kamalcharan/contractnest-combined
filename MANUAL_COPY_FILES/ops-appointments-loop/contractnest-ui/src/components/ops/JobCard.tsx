...
import { ArrowUpRight, Check, Mail, MessageCircle, PhoneCall, UserPlus, PauseCircle, PlayCircle, RefreshCw, X, IndianRupee, CalendarClock, History, Wrench, CalendarCheck, Play, CheckCircle2, Share2, Copy } from 'lucide-react';
...
export const kindLabel = (c: BoardCard, meId?: string): string => {
  switch (c.kind) {
    ...
    case 'visit_scheduled': return c.slot_state === 'confirmed' ? 'Visit confirmed' : c.slot_state === 'proposed' ? (c.visit?.ask?.asked_at ? 'Awaiting customer' : 'Slot proposed') : 'Visit scheduled';
