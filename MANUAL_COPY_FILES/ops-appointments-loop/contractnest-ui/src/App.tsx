  ...
  <Route path="done" element={
    <ProtectedRoute requireTenant={true}>
      <VaniDoneStep />
          ...
          <Route path="/ops/appointments" element={<Navigate to="/ops/cockpit/next?focus=services" replace />} />
          ...
          <Route path="/appointments" element={<Navigate to="/ops/cockpit/next?focus=services" replace />} />
