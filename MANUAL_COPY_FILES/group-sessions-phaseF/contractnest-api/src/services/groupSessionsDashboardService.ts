...
class GroupSessionsDashboardService {
  ...
  markDuePaid(tenantId: string, billingEventId: string, paid: boolean) {
    return this.call('gs_mark_due_paid', { p_tenant: tenantId, p_billing_event: billingEventId, p_paid: paid });
  }
}
