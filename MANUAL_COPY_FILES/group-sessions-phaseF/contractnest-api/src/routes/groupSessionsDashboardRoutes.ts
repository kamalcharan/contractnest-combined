...
// POST /api/group-sessions/due/:billingEventId/paid      → chair marks a due collected
router.post('/due/:billingEventId/paid', groupSessionsDashboardController.markDuePaid);
