...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const confirmEnvironmentSwitch = async () => {
    ...
    // Full reload clears caches. Only the isolated experience keeps its route;
    // all existing screens retain the original cockpit landing behaviour.
    window.location.href = window.location.pathname === '/experience' ? '/experience' : '/ops/cockpit';
  };
