      ...
      <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start space-x-4">
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${colors.brand.primary}30 0%, ${colors.brand.secondary || colors.brand.primary}20 100%)`,
        ...
        >
            ...
            <nav className="flex space-x-1">
              {[
                ...
                <button
                  ...
                  className={cn(
                    "px-4 py-2 rounded-t-xl font-medium text-sm transition-all",
                    activeTab === tab.id
                      ? ""
                      : "hover:opacity-80"
                  )}
          ...
          >
            {activeTab === 'overview' && (
              <div className="space-y-6">
                {/* Profile Information - Simplified without Department/Employee ID/Location */}
                <div>
                  <h3
            ...
            {activeTab === 'permissions' && (
              <div>
                ...
                <div className="space-y-4">
                  {/* Role Display - Using assigned_roles as single source of truth */}
                  <div
                    className="p-4 rounded-xl"
                    style={{
                      backgroundColor: isDarkMode ? 'rgba(255,255,255,0.03)' : 'rgba(0,0,0,0.02)'
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span
                        ...
                        style={{ color: colors.utility.primaryText }}
                      >
                        Role: {primaryRole || 'No role assigned'}
                      </span>
                    </div>
                    <p
                      className="text-sm"
                    ...
                    >
                      {primaryRole
                        ? `This user has ${primaryRole.toLowerCase()} privileges in the workspace.`
                        : 'This user has not been assigned any role yet.'
                      }
                    </p>
                  </div>

                  {/* Show all assigned roles if more than one */}
