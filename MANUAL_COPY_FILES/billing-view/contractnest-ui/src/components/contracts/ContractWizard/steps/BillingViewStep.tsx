...
const BillingViewStep: React.FC<BillingViewStepProps> = ({
  ...
  }, [selectedBlocks, availableTaxRates, selectedTaxRateIds]);
    ...
    >
      ...
      <div className="flex-1 flex gap-4 px-4 py-4 min-h-0">
        ...
        >
          ...
          >
            ...
            {selectedBlocks.map((block, index) => {
              ...
              return (
                <div
                  key={block.id}
                  className="grid grid-cols-[1fr_60px_90px_100px_100px] gap-2 px-4 py-3 border-b items-center"
                  style={{
          ...
          {/* Summary Footer: Subtotal, Tax, Grand Total */}
          <div
          ...
          >
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <Percent className="w-3.5 h-3.5" style={{ color: colors.brand.primary }} />
                <span
