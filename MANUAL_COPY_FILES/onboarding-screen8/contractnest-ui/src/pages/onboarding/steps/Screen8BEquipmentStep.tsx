...
const Screen8BEquipmentStep: React.FC = () => {
  ...
  const persona     = routeState.persona     || 'buyer';
  const companyName = routeState.companyName || 'City General Hospital';
          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                I've created placeholders for common <strong>healthcare equipment</strong>.
          ...
          <div style={{ position: 'sticky', top: 84, paddingLeft: 24 }}>
            ...
            <div style={{
              ...
              {[
                ...
                { k: 'Industry',  v: 'Healthcare', accent: true },
              ].map(row => (
