...
// Empty state for Equipment Registry — context-aware based on selected sub_category
...
const EquipmentEmptyState: React.FC<EquipmentEmptyStateProps> = ({
  ...
  return (
    <div className="text-center py-16 px-6">
      ...
      >
        {selectedSubCategory
          ? `No equipment in ${selectedSubCategory}`
      ...
      >
        {selectedSubCategory
          ? `Add equipment under ${selectedSubCategory} to track assets, link contracts, and manage service schedules.`
          : 'Get started by adding your first equipment. Registered equipment can be linked to contracts, scheduled for service, and tracked with evidence.'}
      </p>
