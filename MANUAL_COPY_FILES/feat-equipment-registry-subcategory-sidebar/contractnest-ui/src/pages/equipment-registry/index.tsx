...
const EquipmentPage: React.FC = () => {
  ...
  // ── Resources (equipment + asset types) ─────────────────────────
  const {
    data: allResources = [],
  ...
  // Filter to only equipment/asset type resources that are active
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      >
        ...
        <p
          ...
          style={{ color: colors.utility.secondaryText }}
        >
          Register and manage the equipment you service. This data powers
          contract creation, scheduling, and evidence tracking.
        </p>
      </div>
            ...
            {categoriesLoading ? (
              ...
              >
                {categoriesError
                  ...
                  : 'No equipment categories configured'}
              </div>
            ) : (
              <>
