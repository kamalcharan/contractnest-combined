...
export interface PlanTemplate {
  ...
  flags: string[];
  /** Template category — 'per_contract' renders as the pay-as-you-go card. */
  category?: string;
  /** Paise per creation, 'per_contract' category only. */
  rates?: Record<string, number>;
  /**
   * The template's authored wizard state, passed through by the edge /plans
   * handler so subscribeToPlan can derive the REAL billing schedule with
   * contractEventsDerivationService. Not for display.
   */
