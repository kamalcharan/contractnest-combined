...
import BuyPage from './pages/buy'; // [extend] public hosted checkout
import ExtendPage from './pages/extend'; // [extend] touchpoint management
    ...
    <>
      ...
      <MiscPageWrapper>
        <Routes>
          ...
          {/* [extend] public hosted checkout — no auth, gated by the storefront key in the URL */}
...
<Route path="/extend" element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
