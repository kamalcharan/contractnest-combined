...
export interface TenantContext {
  ...
  /**
   * Addon flags. vani_ai / rfp have dedicated columns; everything else
   * (addon_extend_website / addon_extend_whatsapp / addon_extend_email, …)
   * arrives merged in from t_tenant_context.addons_extra by
   * get_tenant_context — read via addons['addon_extend_website'] etc.
   */
  addons: { vani_ai: boolean; rfp: boolean; [flag: string]: boolean | undefined };
  flags: {
    can_access: boolean;
