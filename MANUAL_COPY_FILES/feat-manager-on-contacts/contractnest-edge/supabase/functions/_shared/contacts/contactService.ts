  ...
  async createContact(contactData: any, idempotencyKey?: string) {
    try {
      ...
      const rpcContactData = {
        ...
        manager_id: contactData.manager_id || null,
        manager_name: contactData.manager_name || null,
  ...
  async updateContact(contactId: string, updateData: any, idempotencyKey?: string) {
    try {
      ...
      const rpcContactData = {
        ...
        manager_id: updateData.manager_id !== undefined ? (updateData.manager_id || null) : undefined,
        manager_name: updateData.manager_name !== undefined ? (updateData.manager_name || null) : undefined,
