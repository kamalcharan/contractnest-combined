                    ...
                    <>
                      {group.serviceEvents.map((evt) => (
                        <div key={evt.id} className="w-full max-w-[272px]">
                          ...
                          />
                          <EventAssetProgress assets={eventAssetsByEvent[evt.id] || []} colors={colors} />
                        </div>
                      ))}
                        ...
                        (isSeller ? (
                          !hasInvoice && (
                            <button
                              ...
                              className="flex items-center gap-2 px-3 py-2 rounded-lg text-[11px] font-bold border cursor-not-allowed opacity-50"
                              style={{
