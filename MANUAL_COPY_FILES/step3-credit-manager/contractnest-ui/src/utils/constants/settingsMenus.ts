  ...
  },
{
  ...
  */
  ...
  // Subscription section - Enabled for Business Model Phase 4
  {
    id: 'subscription',
  ...
  },
  {
    ...
    description_long: 'View your current plan, usage metrics, and billing details',
    route_path: '/businessmodel/tenants/subscription',
  ...
  },
  {
    ...
    parent_type: GROUP_SUBSCRIPTION,
    description_short: 'Notification credits',
    description_long: 'Manage your notification credits and buy topup packs',
    route_path: '/businessmodel/tenants/subscription/credits',
    card_icon_name: 'Zap',
    adminOnly: false
  }
];
