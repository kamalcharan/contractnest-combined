...
// Data constants (mock categories/resources until APIs exist)
import {
  RESOURCE_TYPES,
  INDUSTRY_CATEGORIES,
  resolveIndustryIcon,
        ...
        <div className="flex gap-6">
              ...
              <div className="max-h-[380px] overflow-y-auto space-y-0.5 pr-1">
                {coverageLoading ? (
                  ...
                  industries.map((industry) => {
                    const icon = resolveIndustryIcon(industry.id, industry.icon);
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              ...
              {(selectedIndustry !== 'all' || selectedResourceType !== 'all' || selectedCategory !== 'all') && (
                <div
                ...
                >
                  ...
                  {selectedIndustry !== 'all' && (
                    ...
                    >
                      {resolveIndustryIcon(selectedIndustry, industries.find(i => i.id === selectedIndustry)?.icon || null)}{' '}
                  ...
                  {selectedResourceType !== 'all' && (
                    ...
                    >
                      {RESOURCE_TYPES.find(r => r.id === selectedResourceType)?.icon}{' '}
                      {RESOURCE_TYPES.find(r => r.id === selectedResourceType)?.name}
