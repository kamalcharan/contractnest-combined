  ...
  async aiAgentMessage(
    ...
    try {
      ...
      const normalizedData: N8NAIAgentResponse = {
        ...
        group_name: (n8nData as any).group_name,
        channel: (n8nData as any).channel,
        // Card rendering fields
        response_type: (n8nData as any).response_type,
        detail_level: (n8nData as any).detail_level,
        // Results data
        results: (n8nData as any).results,
        results_count: (n8nData as any).results_count,
        segments: (n8nData as any).segments,
        // Session/intent fields
        is_new_session: (n8nData as any).is_new_session,
