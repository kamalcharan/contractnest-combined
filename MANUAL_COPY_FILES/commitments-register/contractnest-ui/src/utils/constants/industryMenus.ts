...
{ id: 'home', label: 'Home', icon: 'Home', path: '/experience' },
{
  ...
  // Operations menu - moved after Dashboard for better UX
  {
    ...
    hasSubmenu: true,
    submenuItems: [
      // 2026-09-17 (ops-cockpit-swap): /ops/cockpit IS the Ops board now (revenue side);
      // the "Ops (preview)" staging entry at /ops/cockpit/next is gone (route redirects here).
      ...
      // 2026-09-17 (commitments-register): Event Schedule became the Commitments Register — every event in
      ...
      // RETIRED 2026-09-17 (ops-appointments-loop): the appointment is the visit's slot on the Ops board
