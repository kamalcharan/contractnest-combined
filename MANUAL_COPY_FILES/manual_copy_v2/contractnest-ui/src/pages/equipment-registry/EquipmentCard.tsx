...
import { Pencil, Trash2, MapPin, Shield, AlertTriangle, XCircle, Check, Plus, User, Circle, Archive, RotateCcw, FileText } from 'lucide-react';
          ...
          <div className="flex items-center gap-1.5">
            {!asset.is_active && (
              <span
                ...
                style={{ backgroundColor: colors.utility.secondaryText + '18', color: colors.utility.secondaryText }}
              >
                Inactive
              </span>
            )}
        ...
        {!selectable && !asset.is_active && onReactivate && (
          ...
          >
            <Button
              ...
              style={{
                borderColor: (colors.semantic?.success || '#16a34a') + '40',
