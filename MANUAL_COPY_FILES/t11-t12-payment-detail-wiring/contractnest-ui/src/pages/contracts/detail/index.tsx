  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        {/* Online Payment Attempts (T12) */}
        {invoices.length > 0 && (
          <div className="mt-4">
            <PaymentRequestHistory contractId={contract.id} compact />
          </div>
        )}
      </div>
    </div>
        ...
        return (
          <div className="grid gap-6" style={{ gridTemplateColumns: '1fr 400px' }}>
            ...
            <div className="space-y-6">
              ...
              {/* Payment Request History - full width */}
              <PaymentRequestHistory contractId={contract.id} />
            </div>
