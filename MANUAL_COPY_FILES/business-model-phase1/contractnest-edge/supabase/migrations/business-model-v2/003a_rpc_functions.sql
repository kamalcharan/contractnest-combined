-- ============================================================
-- Migration: 003a_rpc_functions
-- Description: Database RPC functions with race condition handling
-- Author: Claude Code Session
-- Date: 2025-01-11
-- Phase: 1 - Schema & Product Configs (Deliverable 3, Part A)
-- ============================================================

-- ============================================================
-- OVERVIEW - 12 RPC FUNCTIONS
-- ============================================================
...
--   10. get_billing_alerts()   - Billing-related alerts
--   11. calculate_tiered_price() - Calculate price based on tiers
...
-- Uses FOR UPDATE NOWAIT to lock the row during the transaction
...
-- NOTE: Created before get_billing_status because it's called by get_billing_status
...
-- ============================================================
-- MIGRATION 003a COMPLETE - RPC Functions
-- ============================================================
