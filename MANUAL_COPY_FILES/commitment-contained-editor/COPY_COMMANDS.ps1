...
Write-Host 'Copied 3 UI files. Restart UI and Ctrl+F5. Test the Services chapter in /contracts/experience/create?relationship=partner' -ForegroundColor Green
