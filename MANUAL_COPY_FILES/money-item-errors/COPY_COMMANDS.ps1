...
if ($CheckOnly) { Write-Host 'Preflight passed for all 3 UI files. No files changed.' -ForegroundColor Green; exit 0 }
...
Write-Host 'Copied and verified 3 UI files. Restart UI, then Ctrl+F5.' -ForegroundColor Green
