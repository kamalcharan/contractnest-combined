...
// A mangled review link (missing '?') is normalised before the 404 page
import ReviewLinkRedirect from './pages/contracts/review/ReviewLinkRedirect';
...
<Route path="/catalog-studio" element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
  ...
  <Route path="templates-list" element={<CatalogStudioTemplatesListPage />} />
          ...
          <Route path="*" element={<ReviewLinkRedirect fallback={<NotFoundPage />} />} />
        </Routes>
      </MiscPageWrapper>
    </>
  );
